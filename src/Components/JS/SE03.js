...
function ProductPage() {
    ...
    const handlePreBook = () => {
        const productName = 'SE03'; // Replace with the actual product name if dynamic
    ...
    return (
        <div className="product-container">
            <div className="carousel-division">
                <div className="carousel">
                    <div className="carousel-images">
                        ...
                        <img ref={(el) => imagesRef.current[2] = el} src={black} alt="Product Image 3" style={{ opacity: 0 }} />
                    </div>
                </div>
            </div>
            <div className="details-division">
                ...
                <div className="price">
                    <span>&#8377; 40000</span>
                    {/* <span className="old-price">$Y</span> */}
                </div>
                ...
                <button onClick={handlePreBook} className="buy-now">Pre-book</button> {/* Link to the payment form */}
            </div>
